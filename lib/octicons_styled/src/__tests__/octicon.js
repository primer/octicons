...
describe('An icon component', () => {
  ...
  describe('system props', () => {
    ...
    it('respects space props', () => {
      ...
      expect(container.querySelector('svg')).toHaveStyle({marginTop: '4px'})
      expect(container.querySelector('svg')).toHaveStyle({marginLeft: '8px'})
      expect(container.querySelector('svg')).toHaveStyle({marginRight: '16px'})
      expect(container.querySelector('svg')).toHaveStyle({marginBottom: '24px'})
    })
