...
const COMMON = styledSystem.compose(styledSystem.space, styledSystem.color, styledSystem.display)
...
interface IconProps extends StyledSystem.ColorProps, StyledSystem.SpaceProps, StyledSystem.DisplayProps {
  'aria-label'?: string
  className?: string
  size?: number | Size
