...
All icon components in `@primer/styled-octicons` get `COMMON` system props. Read our [System Props](https://primer.style/components/system-props) documentation for a full list of available props.
