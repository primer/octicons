...
title: Ruby
status: Stable
source: 'https://github.com/primer/octicons/tree/main/lib/octicons_gem'
---
...
If using a framework like Rails, please follow the installation instructions outlined [here](https://primer.style/view-components/#installation). 
