...
<img width="960" alt="octicons-scaling" src="https://user-images.githubusercontent.com/10384315/103715870-87eb1d80-4f76-11eb-8b54-c25ba09ecb5f.png" />
...
| Icon | Metaphor | Usage |
| :--: | :--: | :--: |
| <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16"><path fill-rule="evenodd" d="M10.5 7.75a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0zm1.43.75a4.002 4.002 0 01-7.86 0H.75a.75.75 0 110-1.5h3.32a4.001 4.001 0 017.86 0h3.32a.75.75 0 110 1.5h-3.32z"></path></svg> | **Commits** | The `commit` icon is represented as a circle on a line. This symbolizes a point (the circle) along the version history timeline in which changes were made. Use this icon in views to represent individual or groups of commits, including the timeline and the Commits tab in pull requests.
...
By default, all Octicons use an outline style. Some icons have a filled version which should be use only under the following conditions:
...
<Do>
    <img width="456" alt="octicon-mobile-state" src="https://user-images.githubusercontent.com/10384315/103719160-4873ff80-4f7d-11eb-8253-634e1692d96b.png" />
    <Caption>To indicate navigation state in GitHub's native mobile apps</Caption>
</Do>
...
<Note>The exception to this rule is when conveying a "pass"/"fail" pairing which is done using the filled version of the `check-circle` and `x-circle`</Note>
...
<Do>
    <img width="456" alt="octicons-state" src="https://user-images.githubusercontent.com/10384315/103719161-490c9600-4f7d-11eb-9e44-8bafc3fd64b5.png" />
    <Caption>To show state of an action</Caption>
</Do>
...
<Do>
    ...
    <Caption>To indicate the status or completion of an action (for example, an action running).</Caption>
</Do>
