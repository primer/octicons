...
Octicons are available at 16px and 24px frame sizes. 

<!-- Remove: While they can be resized we recommend you use octicons at their original sizes to maintain consistency in stroke width.  -->
<!-- Note why we don't recommend using other sizes. -->
