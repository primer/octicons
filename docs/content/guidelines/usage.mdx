...
Octicons are a set of icons that are custom to GitHub. When using an octicon keep in mind that an icon should be used for _emphasis_ of the context it supports. 

Remember: Not everything needs an icon. Consider a text label before adding an icon. Adding an octicon should be intentional. 
