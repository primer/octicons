...
Use the following shapes as sizing references to ensure that "optical volume" of your icon is consistent with the rest of the set. See the "Grid and Optical Volume" section of [Nucleo's Icon Guidelines](https://blog.nucleoapp.com/nucleo-icon-guidelines-introduction-70092f8b4697) to learn more about "optical volume."
...
Use a 1px gap to separate 1px overlapping objects.
...
Design with 2D perspective unless depth makes the icon more recognizable.
...
<Grid gridTemplateColumns={['1fr', null, null, null, '1fr 1fr']} gridGap={4}>
    <Do>
        ...
        <Caption>Design with 2D perspective</Caption>
    </Do>
    <Dont>
        <Flex bg="gray.1" justifyContent="center">
